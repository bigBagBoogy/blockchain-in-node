...
export async function handleUserInput(sender, recipient, amount, callback) {
...
function isValidTransaction(transaction, sender) {
...
export function getSenderBalance(sender) {
...
const pendingTransactions = []; // This array stores pending transactions
function addToPendingTransactions(transaction) {
